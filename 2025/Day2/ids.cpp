...
int main(int argc, char* argv[])
{
	if (argc >= 3 && *argv[2] == '1')
	{
		...
		std::cout << "Sum of invalid IDs: " << partOne(argv[1]) << std::endl;
		return 0;
	}
	else if (argc >= 3 && *argv[2] == '2')
	{
		std::cout << "Running Just Part Two" << std::endl;
		std::cout << "Sum of invalid IDs: " << partTwo(argv[1]) << std::endl;
		return 0;
	}
	else if (argc >= 2)
	{
		std::cout << "Sum of invalid IDs for part one: " << partOne(argv[1]) << std::endl;
		std::cout << "Sum of invalid IDs for part two: " << partTwo(argv[1]) << std::endl;
		return 0;
	}
	else
	{
